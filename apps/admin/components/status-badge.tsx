...
const TONE: Record<string, string> = {
  ...
  PREPARING: "border-transparent bg-sky-500/15 text-sky-400",
  CHARGING: "border-transparent bg-amber-500/15 text-amber-400",
  SUSPENDED: "border-transparent bg-amber-500/15 text-amber-400",
  FINISHING: "border-transparent bg-violet-500/15 text-violet-400",
