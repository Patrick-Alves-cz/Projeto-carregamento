...
export const createTariffSchema = z
  .object({
    ...
    parkingPriceCents: z.number().int().min(0).max(100000).default(0),
    minimumChargeCents: z.number().int().min(0).max(100000).default(0),
...
export const updateTariffSchema = z
  .object({
    ...
    parkingPriceCents: z.number().int().min(0).max(100000).optional(),
    minimumChargeCents: z.number().int().min(0).max(100000).optional(),
